...
execute at @s positioned ~ ~1 ~ run function lodeport:effects/ring
execute at @s run function lodeport:effects/ring
execute at @s positioned ~ ~-0.5 ~ run function lodeport:effects/ring
